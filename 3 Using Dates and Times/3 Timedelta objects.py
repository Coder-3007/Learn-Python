# We will learn  file for working with timedelta objects in Python
...
if afd < today:
    print("April's fools Day aleardy went by :", (today-afd).days)
    afd = afd.replace(year= today.year + 1)

# TODO: Now calculate the amount of time until April Fool's Day  

time_to_afd = afd - today
print("It is", time_to_afd.days, "days until the next April fools days !")